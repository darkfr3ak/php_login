...
class SASLClient {
    ...
    private $drivers = array(
        "Digest" => array("Digest_SASL_Client", "Digest_SASL_Client.class.php"),
        "CRAM-MD5" => array("Cram_MD5_Sasl_Client", "Cram_MD5_Sasl_Client.class.php"),
        "LOGIN" => array("Login_SASL_Client", "Login_SASL_Client.class.php"),
        "NTLM" => array("NTLM_SASL_Client", "NTLM_SASL_Client.class.php"),
        "PLAIN" => array("Plain_SASL_Client", "Plain_SASL_Client.class.php"),
        "Basic" => array("Basic_SASL_Client", "Basic_SASL_Client.class.php")
    );
