...
class SMTP {
    ...
    /*
      ...
      {/metadocument}
     */
    public $http_proxy_host_port = 80;
    ...
    /*
      ...
      {/metadocument}
     */
    public $user_agent = 'SMTP Class (http://www.phpclasses.org/smtpclass $Revision: 1.48 $)';
    ...
    private $result_code;
    private $disconnected_error = 0;
    private $esmtp_host = "";
    private $maximum_piped_recipients = 100;
    ...
    Function SASLAuthenticate($mechanisms, $credentials, &$authenticated, &$mechanism) {
        $authenticated = 0;
        if (!function_exists("class_exists") || !class_exists("SASLClient")) {
